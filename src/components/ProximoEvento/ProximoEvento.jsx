			...
			<div className="flex flex-col my-3 rounded-sm">
				...
				{/* <ul className="flex flex-col text-left ml-8 mr-4 list-disc space-y-2 font-serif font-semibold">
					<li className="">
						...
						organizaciones de masas. Venta de alimentos 4:00pm. Momento ambiental en coordinación con CESAM.
						Continuación de actividades en Parque Josone
					</li>
					<li>
						Jueves 9 de febrero 9:30am. Parque Josone Varadero. Recibimiento, Inscripciones, Música.
						Exhibición de los trabajos finalistas del concurso “ La moto de mis sueños”. Competencia Rally
						contra reloj, en territorio Varadero Ofertas gastronómicas 6:00pm. Concierto de Rock
					</li>
					<li>
						Viernes 10 de febrero 9:00am. Parque Josone Varadero. Rodada por instalaciones hoteleras, parada
						en una de ellas. 1:00 – 6:00pm. Estancia en Hotel de la cadena Islazul Regreso al parque,
						reanudación de actividades En la noche Concierto de Rock{' '}
					</li>
					<li>
						Sábado 11 de febrero 9:00am. Concentración de motos en la entrada a Santa Marta, pista
						Aeropuerto Viejo – Rodada por Varadero Actividades del encuentro durante todo el día:
						Continuación de inscripciones, Juegos amistosos entre motociclistas Presentación de Proyectos
						comunitarios. Ofertas gastronómicas.
					</li>
					<li>
				 ...
				 <p className="justify-center mx-3 py-1">
					...
					ESTABLECIDA. CADA PERSONA ES RESPONSABLE DE SU ACTUAR Y DISCIPLINA Y EL ENCUENTRO NO SE
					RESPONSABILIZA POR VIOLACIONES DE LA LEY EN NINGÚN PUNTO. GRACIAS POR PARTICIPAR!! Oraganizadores
					del Encuentro
				</p>
			</div>
		</div>

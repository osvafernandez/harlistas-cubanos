    ...
    <div id="inicio" className="text-white">
      <div className="flex flex-col justify-center w-full mx-auto max-w-35">
        ...
        <p className="flex text-start p-3 mx-4 font-sans text-lg font-semibold">
          ...
          reconocida a nivel mundial. La carencia de partes y piezas para estas
          motocicletas provocadas por el embargo comercial al que ha estado
          sometido el país por más de 50 años ha hecho que la historia de los
          “Harlistas Cubanos” sea tan apasionante y mística como lo es la misma
          historia de la Harley-Davidson. Con estas paginas queremos dejar
          plasmada la semblanza de algunos de los más emblemáticos personajes
          contemporáneos a nuestra época y que han traspasado la frontera del
